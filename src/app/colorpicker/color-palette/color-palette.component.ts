...
export class ColorPaletteComponent implements OnInit, AfterViewInit, OnChanges {
  ...
  constructor(private colorService : ColorService){
    ...
    this.colorService.hueChanged.subscribe( (h : string) => {
  ...
  ngOnInit(){
    this.hue = this.colorService.color
  ...
  ngOnChanges(changes: SimpleChanges) {
    if (changes['hue']) {
      ...
      if (pos) {
        this.colorService.setColor(this.getColorAtPosition(pos.x, pos.y))
      }
    }
  }
  ...
  onMouseDown(evt: MouseEvent) {
    ...
    this.draw()
    this.colorService.setColor(this.getColorAtPosition(evt.offsetX, evt.offsetY))
  }
